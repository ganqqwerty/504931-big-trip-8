...
class Component {
  ...
  render() {
    this._element = Object(_create_element__WEBPACK_IMPORTED_MODULE_0__["default"])(this.template);
    this.bind();
    return this._element;
  }
...
class EventEdit extends _component_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor(data) {
    super();
...
class Event extends _component_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor(data) {
    super();
    this._title = data.title;
    this._type = data.type;
...
/* harmony import */ var _event_edit_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./event-edit.js */ "./src/event-edit.js");
...
const renderEvents = function (section, arr) {
  arr.forEach(function (element) {
    const eventComponent = new _event_js__WEBPACK_IMPORTED_MODULE_1__["default"](element);
    const editEventComponent = new _event_edit_js__WEBPACK_IMPORTED_MODULE_2__["default"](element);
